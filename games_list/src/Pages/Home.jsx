...
function Home() {
  ...
  return (
    <div className='grid grid-cols-4 p-8'>
        ...
        selectedGenreId={(genreId)=>getGameList(genreId)} selectedGenresName = {(name) => setSelectedGenresName(name)}/></div>
       ...
       <div className='md:col-span-3 col-span-4 px-3'>
            ...
            <PopularGameList gameList={gameListByGenre} selectedGenresName = {selectedGenresName} />
        </div>
        :null}
    </div>
  )
